...
export function MainHero() {
  return (
      <div className="text-center p-8 text-gray-800 dark:text-gray-100">
          <Button className="mb-1 bg-transparent border border-slate-200 hover:border-orange-300 hover:bg-slate-100 shadow-stone-600/10 hover:shadow-orange-400/20 shadow-xl hover:shadow-xl text-stone-500 hover:text-gray-500"asChild>
            <Link href="#launch-service">
              <RocketIcon/> 
              <span className="tracking-wide font-extrabold mr-2 ml-2 text-xs">
