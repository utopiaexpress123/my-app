  ...
  return (
      <div className="text-center p-8 text-gray-800 dark:text-gray-100">
        ...
        <div className="mt-6 mb-5">
          ...
          <Button className="h-13 mb-4 bg-transparent border border-slate-100 hover:border-fuchsia-200 hover:bg-slate-100 shadow-fuchsia-600/10 hover:shadow-fuchsia-400/20 shadow-xl hover:shadow-xl text-stone-500 hover:text-gray-500" asChild>
            <Link href="#">
              <Avatar>
