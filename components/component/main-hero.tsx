  ...
  return (
      <div className="text-center p-8 text-gray-800 dark:text-gray-100">
        ...
        <Button className="h-13 m-4 bg-transparent border border-slate-100 hover:border-fuchsia-200 hover:bg-slate-100 shadow-fuchsia-600/10 hover:shadow-fuchsia-400/20 shadow-xl hover:shadow-xl text-stone-500 hover:text-gray-500" asChild>
            <Link href="https://www.youtube.com/channel/UCZxVdlr2Ez4xkq97fGbG3IQ" target="_blank">
              <span className="transition-all mr-3 text-slate-500 hover:text-slate-400">Utopia Research Assistant</span>
        ...
        <Button className="h-13 m-4 bg-transparent border border-slate-100 hover:border-fuchsia-200 hover:bg-slate-100 shadow-fuchsia-600/10 hover:shadow-fuchsia-400/20 shadow-xl hover:shadow-xl text-stone-500 hover:text-gray-500" asChild>
            <Link href="#">
              <span className="transition-all mr-3 text-slate-500 hover:text-slate-400">Utopia Uplifting Sounds</span>
              <YoutubeIcon/>
            </Link>
        </Button>
