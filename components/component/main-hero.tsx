...
function BankCardIcon(props) {
  return (
<svg  {...props} className="fill-rose-300  hover:text-rose-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
